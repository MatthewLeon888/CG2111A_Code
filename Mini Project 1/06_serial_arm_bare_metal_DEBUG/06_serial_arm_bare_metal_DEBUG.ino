...
// TAKE ANOTHER ANOTHER NOTE: The following code will only focus on the simpliest cases for debugging purposes 
...
static volatile bool countUp = true;

ISR(TIMER1_COMPB_vect) {
  // Turn ON first servo
  PORTC |= (1 << PC0);

  // Intended Effect: Servo at Pin PC0 will rotate back and forth between 0deg and 180deg
  // Time taken should be take 8s from 0deg to 180deg
