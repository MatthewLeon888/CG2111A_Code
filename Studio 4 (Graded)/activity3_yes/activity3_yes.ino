...
void setup() {
  ...
  TCCR1A = 0b10000001; // Set OCOM0A to 10 and WGM to 01
  // Set TCCR0A to 0b11000001 for complement

  TIMSK1 |= 0b10; // Enable Int for Output Compare Match

  OCR1A = 25; // OCR0A can accept from 0 to 255

  TCNT1 = 0;

  TCCR1B = 0b00000100; // Set clk source to clk/64
